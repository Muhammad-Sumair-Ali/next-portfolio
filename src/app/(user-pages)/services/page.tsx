...
const contactOptions = [
  {
    name: "WhatsApp",
    icon: MessageCircle,
    href: `https://wa.me/923194075607?text=Hi%20Muhammad%20Sumair,%20I'm%20interested%20in%20your%20${encodeURIComponent(
  ...
  },
  {
    name: "Email",
    icon: Mail,
    href: `mailto:muhammadsumair224@gmail.com?subject=Service Request: ${encodeURIComponent(
      selectedService?.title || ""
    )}&body=Hi Muhammad Sumair,%0D%0A%0D%0AI'm interested in your ${encodeURIComponent(
      selectedService?.title || "services"
    )}.%0D%0A%0D%0APlease let me know the next steps.`,
        ...
        <div className="w-full max-w-[520px] rounded-2xl border border-zinc-200 mt-16 dark:border-zinc-800 p-6 sm:p-8 ">
          ...
          <div className="grid gap-3 mt-6">
            {contactOptions.map((option, index) => (
              ...
              >
                <div
                  className={`${option.color} rounded-xl p-4 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-lg`}
                >
