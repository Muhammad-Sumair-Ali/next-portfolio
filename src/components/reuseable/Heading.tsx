    ...
    <motion.div ref={scope} initial={{ opacity: 0, y: 20 }}>
      <div className="pt-36 px-8 pb-16 max-w-[1010px] m-auto">
        <div className="text-left flex items-start flex-col">
          <motion.h1
            className="text-3xl md:text-4xl font-semibold bg-gradient-to-br from-zinc-900 to-zinc-600 dark:from-white dark:to-zinc-600 bg-clip-text text-transparent mb-4"
          ...
          <motion.p
            className="text-lg text-zinc-700 dark:text-gray-400"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
