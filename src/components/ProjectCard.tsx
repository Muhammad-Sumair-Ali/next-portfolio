...
export function ProjectCard({ project }) {
  ...
  return (
    ...
    >
      <Card className="group relative overflow-hidden rounded-lg border-zinc-800 bg-gradient-to-br from-zinc-900 to-black shadow-xl transition-all duration-300 hover:shadow-2xl hover:shadow-zinc-800/20">
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent opacity-60 transition-opacity group-hover:opacity-100" />
      ...
      <Dialog open={showDetails} onOpenChange={setShowDetails}>
        <DialogContent className="max-w-2xl border-0 bg-zinc-950 text-white">
          <DialogHeader>
